  ...
  _createClass(Items, [{
    ...
    value: function calcDimensionConnections(items, connections) {
      function calculate(id, start, end, warning) {
        ...
        var horizontallyAligned = startY === endY;
    ...
    value: function render() {
      ...
      var canvasHeight = this.props.groupHeights.reduce(function (a, b) {
        return a + b;
      }, 0);
      ...
      return _react2.default.createElement(
        ...
        visibleItems.filter(function (item) {
          ...
          return _react2.default.createElement(_Item2.default, {
            ...
            collisionIncrease: _this2.props.collisionIncrease,
            increaseCollisionToSmallItems: _this2.props.increaseCollisionToSmallItems,
