      ...
      if (this.item) {
        (0, _interactjs2.default)(this.item).dropzone({
          ...
          ondragenter: function ondragenter(event) {
            _this3.props.onPointEnter(event, _this3.itemId, Number(event.relatedTarget.id));
          },
          ondrop: function ondrop(event) {
            _this3.props.onPointDrop(event, _this3.itemId, Number(event.relatedTarget.id));
          },
          ondragleave: function ondragleave(event) {
            _this3.props.onPointLeave(event, _this3.itemId, Number(event.relatedTarget.id));
          }
        });
      }
    }
