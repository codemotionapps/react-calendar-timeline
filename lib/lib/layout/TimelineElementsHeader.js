...
function handleHeaderMouseDown(_ref) {
...
function checkCoordinates(event) {
  var xMatches = event.clientX === event.target.originalCoordinates.x;
  var yMatches = event.clientY === event.target.originalCoordinates.y;
          ...
          topHeaderLabels.push(_react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick(event) {
                return checkCoordinates(event.nativeEvent) && _this2.handlePeriodClick(time, nextUnit);
              },
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        bottomHeaderLabels.push(_react2.default.createElement(
          'div',
          {
            ...
            onClick: function onClick(event) {
              return checkCoordinates(event.nativeEvent) && _this2.handlePeriodClick(time, minUnit);
            },
            onMouseDown: handleHeaderMouseDown,
            style: {
