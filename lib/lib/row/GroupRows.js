  ...
  _createClass(GroupRows, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        lines,
        droppable && _react2.default.createElement(
          _reactBeautifulDnd.Droppable,
          { droppableId: 'empty-row' },
          function (provided) {
            return _react2.default.createElement(
              _PreventClickOnDrag2.default,
              { clickTolerance: clickTolerance, onClick: function onClick(evt) {
                  return onRowClick(evt, 'empty-row');
                } },
              _react2.default.createElement('div', { style: { width: canvasWidth }, ref: provided.innerRef, className: 'empty-row grow' })
            );
          }
        )
      );
