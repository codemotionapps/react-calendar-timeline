        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { onClick: this.props.onClickOuter, style: outerComponentStyle, className: 'rct-outer' },
                _react2.default.createElement(
                  ...
                  !this.props.noHeader && _react2.default.createElement('div', { style: { height: 64 } }),
                  _react2.default.createElement(
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.resize = function () {
    ...
    if (_this4.headerRef) _this4.headerRef.scrollLeft = width;
  };
  ...
  this.onScroll = function (scrollX) {
    ...
    if (_this4.headerRef) _this4.headerRef.scrollLeft = newScrollX;
  ...
  this.resizedItem = function (item, resizeTime, edge, timeDelta, type) {
    _this4.setState({ resizingItem: null, resizingEdge: null, resizeTime: null });
    if (_this4.props.onItemResize && timeDelta !== 0) {
      _this4.props.onItemResize(item, resizeTime, edge, type);
    }
  };
  ...
  this.handleRowClick = function (e, rowIndex) {
    ...
    if (rowIndex === 'empty-row') {
      _this4.props.onCanvasClick('empty-row', time, e);
      return;
    }
